...
# 5: add missing dates to the "summer" track
   ...
   temp<-trn2
   if(is.null(sun_angle_start)){sun_angle_start<-as.numeric(-5)}
   if(is.na(sun_angle_start)){temp$sun<-as.numeric(-5)}
   ...
   if(col_lat>0){(winter_days<-c(290:366,1:50))}else{winter_days<-c(110:210)}
   if(species%in%c("Arctic tern","arctic tern","Sterna paradisaea","sterna paradisaea","ARTE")){(winter_days<-c(285:366,1:60,110:247))}
