...
#---------------------- specify species and colony and who is running the analysis ---------------
Colony = "Halten"
...
setwd("C:/Users/vegard.brathen/Norsk Polarinstitutt/Benjamin Merkel - SEATRACK - shared/Database/Imports_Positions_seatrackGLS/seatrackGLS")
# Load seatrackGLS
devtools::load_all(".")
library(seatrackGLS)
```
...
```{r echo=TRUE,results='hide',message = FALSE}
#install_github("SLisovski/GeoLocTools") #run if installing GeoLocTools
library(GeoLocTools)
#setupGeolocation() #run if installing GeoLocTools
```

Other packages needed here is the 'seatrackR' package in order to extract information from the SEATRACK database:
```{r echo=TRUE,results='hide',message = FALSE}
library(seatrackR)#devtools::install_github('NINAnor/seatrack-db/seatrackR',force = TRUE)
```
